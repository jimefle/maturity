...
export default function Card({titulo, descrip, boton, href}){
    return(
        <div class="bg-zinc-900 text-center text-white p-6 rounded-lg shadow-md w-full max-w-xs border border-zinc-700">
            <h2 class="text-lg font-semibold mb-2">{titulo}</h2>
            <p class="text-sm text-zinc-400 mb-4">{descrip}</p>
